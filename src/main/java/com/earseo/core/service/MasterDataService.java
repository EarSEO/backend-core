...
public class MasterDataService {
    ...
    public List<MiddleDataDto> getMiddleData(List<FilteredDataDto> filteredData, int start) {
        ...
        for (FilteredDataDto filteredDataDto : filteredData) {
            ...
            else imageItemDto = new ImageItemDto(imageItem.get("originimgurl").asText(),imageItem.get("smallimageurl").asText());

            if(commonItem == null) commonItemDto = new CommonItemDto(null,null,null,null,null,null,null,null,null);
